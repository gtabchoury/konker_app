...
class _RestDestinationsPageState extends State<RestDestinationsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _removeRestDestination(
        String restDestinationGuid, String restDestinationName) async {
      if (await confirm(
        context,
        ...
        try {
          await RestDestinationService.delete(
              restDestinationGuid, "default", token!);
    ...
    Future<bool> loadRestDestinations() async {
      ...
      List<RestDestination> restDestinations =
          await RestDestinationService.getAll("default", token!);
        ...
        _rows.add(new DataRow(
          cells: [
            ...
            DataCell(GestureDetector(
                ...
                onTap: () {
                  _removeRestDestination(d.guid!, d.name);
                })),
            DataCell(GestureDetector(
                child: Icon(
                  Icons.edit,
